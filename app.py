...
if "database_soal" not in st.session_state:
    st.session_state.database_soal = [
        ...
        # ==================== POIN 4: ～（よ）うとしている ====================
        {
            "id": 15,
            "pola": "4. ～（よ）うとしている",
            "kanji": "さあ、いま決勝戦が始まろうとしています。みんな緊張しています。",
        ...
        },
        {
            ...
            "soal": ["かんせい", "えきまえ", "こうきゅうまんしょん", "に", "しよう", "が", "としている", "。"],
        ...
        },
        {
            ...
            "soal": ["たいけん", "たのしみ", "せいかつ に", "にほん", "いろいろな", "なれていった", "の", "つつ", "、", "を"],
...
def render_kuis_lengkap():
    ...
    # 2. BANK KATA PILIHAN (4 Kolom Sesuai Asli)
